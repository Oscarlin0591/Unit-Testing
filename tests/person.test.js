...
describe("Person", () => {
  ...
  describe("constructor", () => {
    ...
    test("sets dateOfBirth as a Date object", () =>
  ...
  describe("null fields", () => {
    test("stores null userName as null", () => {
      const p = new Person("Doe", "John", school, "1990-01-15", null, "student");
      expect(p.userName).toBeNull();
    });

    test("email uses 'null' string when userName is null", () => {
      const p = new Person("Doe", "John", school, "1990-01-15", null, "student");
      expect(p.email).toBe("null@test.edu");
    });

    test("stores null lastName as null", () => {
      const p = new Person(null, "John", school, "1990-01-15", "jdoe", "student");
